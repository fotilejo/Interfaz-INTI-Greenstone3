...
CKEDITOR.editorConfig = function( config ) {
    ...
    // add in the image plugin - allows editing image links etc, and
    // sourcedialog plugin - give a sourcecode view for editing.
    config.extraPlugins = 'image,sourcedialog';
};
